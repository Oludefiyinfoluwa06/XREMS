            ...
            <ScrollView className='p-[25px]'>
                ...
                <View className='w-full'>
                    ...
                    <TextInput
                        ...
                        className='p-[5px] px-[10px] w-full border border-gray rounded-[50px] mb-[20px]'
                        secureTextEntry
                        value={password}
                        onChangeText={(value) => {
                            setPassword(value);
                    ...
                    <TouchableOpacity className='w-full my-[20px]' onPress={() => router.push('/admin/forgot-password')}>
                    ...
                    <View className='flex-row items-center justify-center gap-2'>
                        ...
                        <TouchableOpacity onPress={() => router.push('/admin/sign-up')}>
